...
class BrandProduct extends Controller
{
    ...
    //End Function Admin Page
     ...
     public function show_brand_home($brand_slug){
        ...
        return view('pages.brand.show_brand')->with('category',$cate_product)->with('brand',$brand_product)->with('brand_by_id',$brand_by_id)->with('brand_name',$brand_name)->with('all_slide',$all_slide)->with('diachi',$diachi);
    }
}
