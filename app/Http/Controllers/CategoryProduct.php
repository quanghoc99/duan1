...
class CategoryProduct extends Controller
{
    ...
    public function show_category_home($slug_category_product){
        ...
        return view('pages.category.show_category')->with('category',$cate_product)->with('brand',$brand_product)->with('category_by_id',$category_by_id)->with('category_name',$category_name)->with('all_slide',$all_slide)->with('diachi',$diachi);
    }
