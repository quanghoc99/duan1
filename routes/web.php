...
Route::post('/update-slide/{slide_id}','SlideController@update_slide');
// user
...
Route::post('/save-user-tt','UserController@save_user_tt');

// lienhe
Route::get('/all-lienhe','DiachiController@index');
Route::get('/edit-lienhe/{lienhe_id}','DiachiController@edit_lienhe');
Route::post('/update-lienhe/{lienhe_id}','DiachiController@update_lienhe');
...
Route::get('/add-product-cart/{product_id}','HomeController@muahang');
